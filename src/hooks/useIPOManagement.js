...
export function useIPOManagement({ setUserData, setLoadingKey }) {
  const { user, userData, marketData, showNotification } = useAppContext();
  ...
  }, [user, userData, marketData, setUserData, setLoadingKey, showNotification]);
