...
const AchievementsPage = () => {
  ...
  const categories = {
    'Trading': ['FIRST_BLOOD', 'SHARK', 'DIVERSIFIED', 'UNIFIER', 'MONOPOLY', 'TRADER_20', 'TRADER_100'],
    'Profits': ['BULL_RUN', 'DIAMOND_HANDS', 'COLD_BLOODED', 'NPC_LOVER', 'DISCOUNT_DEACON', 'PROFIT_CHAMPION'],
